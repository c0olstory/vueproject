<template>
  <div :class="[$style.pagination]">
    <v-btn :ripple="false" plain
      :to="{ name: 'dashboardPage', params: { page: +this.currentPage - 1 }}"
      :class="[
    ...
    <v-btn active-class :ripple="false" plain
      :to="{ name: 'dashboardPage', params: { page: page }}"
