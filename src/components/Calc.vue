<template>
  <div class="calculator">
    <input class="calculator__input" v-model.number="operand1" name="operand1" />
    <input class="calculator__input" v-model.number="operand2" name="operand2" />
    = {{ result }}
    ...
    <input type="checkbox" id="checkbox" v-model="checked" name="check">
    ...
    <br>
    <input type="radio" id="one" value="1" v-model="picked"   name="radioOp1">
    <label for="one">Operand-1</label>
    <input type="radio" id="two" value="2" v-model="picked" name="radioOp2">
